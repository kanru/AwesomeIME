...
public class AwesomeIME extends InputMethodService 
                ...
                case MSG_START_TUTORIAL:
                    if (mTutorial == null) {
                        if (mInputView.isShown()) {
                            mTutorial = new Tutorial(AwesomeIME.this, mInputView);
                            mTutorial.start();
                        } else {
    ...
    public void onStartInputView(EditorInfo attribute, boolean restarting) {
        ...
        if (TRACE) Debug.startMethodTracing("/data/trace/acinime");
    }
    ...
    private void measureCps() {
        if (!AwesomeIME.PERF_DEBUG) return;
    ...
    class AutoDictionary extends ExpandableDictionary {
        ...
        public void addWord(String word, int addFrequency) {
            ...
            if (freq > PROMOTION_THRESHOLD) {
                AwesomeIME.this.promoteToUserDictionary(word, FREQUENCY_FOR_AUTO_ADD);
            }
        }
    }
}
